...
from data.models import VocationalEdSpending
import csv
...
# 4) change 'amount' column in data_VocationalEdSpending table to type 'bigint'
# 5) Run as Django management command from your project path "python manage.py import_vocational_ed_spending"

SOURCE_FILE = '%s/education/vocational_ed_spending.csv' % (settings.LOCAL_DATA_ROOT)
