...
from data.models import SpecialEdFunding
import csv
...
# 4) change 'amount' column in data_SpecialEdFunding table to type 'bigint'
# 5) Run as Django management command from your project path "python manage.py import_special_ed_funding"

SOURCE_FILE = '%s/education/special_ed_funding.csv' % (settings.LOCAL_DATA_ROOT)
